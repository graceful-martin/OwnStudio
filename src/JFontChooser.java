...
public class JFontChooser extends JComponent
{
	...
	protected String getMyProperty(String key)
	{
		String value = key;
		switch(key) {
		case "Verion": return "1.0.5";
		case "SelectFont": return "폰트 선택";
		case "OK": return "확인";
		case "Cancel": return "취소";
		case "FontName": return "폰트이름";
		case "FontStyle": return "스타일";
		case "FontSize": return "크기";
		case "Sample": return "예시";
		case "SampleString": return "AaBbYyZz가나다라";
		case "Plain": return "보통";
		case "Bold": return "두껍게";
		case "Italic": return "기울게";
		case "BoldItalic": return "두꺼운 기울게";
		}
		return value;
	}
...
//	}
	...
	protected class DialogOKAction extends AbstractAction
	{
		...
		protected DialogOKAction(JDialog dialog)
		{
			...
			putValue(Action.NAME, getMyProperty(ACTION_NAME));
		}
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, getMyProperty("SelectFont"), true);
	...
	protected JPanel getFontFamilyPanel()
	{
		if (fontNamePanel == null)
		{
			...
			JLabel label = new JLabel(getMyProperty("FontName"));
	...
	protected JPanel getFontStylePanel()
	{
		if (fontStylePanel == null)
		{
			...
			JLabel label = new JLabel(getMyProperty("FontStyle"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getFontSizePanel()
	{
		if (fontSizePanel == null)
		{
			...
			JLabel label = new JLabel(getMyProperty("FontSize"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getSamplePanel()
	{
		if (samplePanel == null)
		{
			Border titledBorder = BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(), getMyProperty("Sample"));
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField(getMyProperty("SampleString"));
	...
	protected String[] getFontStyleNames()
	{
		if (fontStyleNames == null)
		{
			...
			fontStyleNames[i++] = getMyProperty("Plain");
			fontStyleNames[i++] = getMyProperty("Bold");
			fontStyleNames[i++] = getMyProperty("Italic");
			fontStyleNames[i++] = getMyProperty("BoldItalic");
		}
